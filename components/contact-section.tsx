    ...
    <section id="contact" className="min-h-[70vh] flex items-center px-6 py-32">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-light tracking-wide">{t.contact.sectionTitle}</h2>
        ...
        <div className="mb-12">
          <p className="font-mono text-[10px] tracking-[0.2em] uppercase text-muted-foreground mb-3">
            {t.contact.correspondence}
          </p>
          <a
            href="mailto:qzycoco@gmail.com"
